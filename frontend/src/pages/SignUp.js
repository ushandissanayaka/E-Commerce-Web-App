...
function SignUp() {
   ...
   const handleSubmit = async(e) =>{
     ...
     if(data.password === data.confirmPassword){
      ...
      console.log("plase check password and confirm password")
     }
        ...
        <div className='bg-white p-5 w-full max-w-sm mx-auto '>
           ...
           <div className='grid'>
            ...
            <div>
              ...
              required
              className='w-full h-full outline-none bg-transparent'></input>
              <div className='cursor-pointer text-xl' onClick={() =>setShowConfirmPassword((preve)=>!preve)}  /*on click time eye open and close */>
                <span>
                        {
                          showConfirmPassword ? (
                            <FaEyeSlash/>
            ...
            <button  className='bg-black hover:bg-red-800 text-white px-6 py-2 w-full max-w-[150px] rounded-full hover:scale-110 transition-all mx-auto block mt-6'>Sign up</button>
